...
export const LIGHT_SURFACE_TEXT_FILL = OpticsLabColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link OpticsLabColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: OpticsLabColors.controlSurfaceColorProperty,
  listFill: OpticsLabColors.controlSurfaceColorProperty,
  buttonStroke: OpticsLabColors.panelBorderColorProperty,
  listStroke: OpticsLabColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: OpticsLabColors.textColorProperty },
  },
